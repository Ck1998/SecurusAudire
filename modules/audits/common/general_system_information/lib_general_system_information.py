...
class GeneralSystemInformation(BaseTest):
    ...
    def get_boot_time(self):
        ...
        self.test_results['Boot Time']["result"]  = None
        self.test_results['Boot Time']["args"]  = f"{bt.year}/{bt.month}/{bt.day} {bt.hour}:{bt.minute}:{bt.second}"
    
    def get_system_information(self):
        sys_info = platform.uname()
        self.test_results["System Information"] = {}
        self.test_results["System Information"].update(result = None, args = {
    ...
    def get_cpu_info(self):
        ...
        self.test_results["CPU Information"].update( result = None, args = {
        ...
        for i, percentage in enumerate(psutil.cpu_percent(percpu=True)):
            core_name = f"Core {i}"
            self.test_results["CPU Information"]["args"]['CPU_Usage_Per_Core'][core_name] = f"{percentage} %"

    def get_memory_info(self):
        svmem = psutil.virtual_memory()
        self.test_results["Memory Information"] = {}
        self.test_results["Memory Information"].update( result = None, args = {
    ...
    def get_swap_info(self):
        ...
        self.test_results["Swap Information"].update( result = None, args = {
    ...
    def get_disk_info(self):
        ...
        for partition in partitions:
            self.test_results["Disk Information"]['args'][partition.device] = {}
            try:
                partition_usage = psutil.disk_usage(partition.mountpoint)
            except PermissionError:
                continue

            self.test_results["Disk Information"]['args'][partition.device].update(
        ...
        self.test_results["Disk Information"]['args']["Total read (Since Boot)"] = self.util_obj.get_size(disk_io.read_bytes)
        self.test_results["Disk Information"]['args']["Total write (Since Boot)"] = self.util_obj.get_size(disk_io.write_bytes)
    ...
    def get_network_info(self):
        ...
        for interface_name, interface_addresses in if_addrs.items():
            ...
            self.test_results["Network Information"]["args"][interface_name] = {}
        
            for address in interface_addresses:
                if str(address.family) == 'AddressFamily.AF_INET':
                    self.test_results["Network Information"]["args"][interface_name].update(
        ...
        self.test_results["Network Information"]["args"]["Total Bytes Sent (Since Boot)"] = self.util_obj.get_size(net_io.bytes_sent)
        self.test_results["Network Information"]["args"]["Total Bytes Received (Since Boot)"] = self.util_obj.get_size(net_io.bytes_recv)
