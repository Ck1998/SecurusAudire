...
class GeneralSystemInformation(BaseTest):
    ...
    def get_boot_time(self):
        ...
        self.test_results['Boot Time']  = f"{bt.year}/{bt.month}/{bt.day} {bt.hour}:{bt.minute}:{bt.second}"
    
    def get_system_information(self):
        sys_info = platform.uname()
        self.test_results["System Information"] = {}
        self.test_results["System Information"].update(
    ...
    def get_cpu_info(self):
        ...
        self.test_results["CPU Information"].update(
    ...
    def get_memory_info(self):
        ...
        self.test_results["Memory Information"].update(
            ...
            Percentage = self.util_obj.get_size(svmem.percent)
        )

    def get_swap_info(self):
        swap = psutil.swap_memory()
        self.test_results["Swap Information"] = {}
        self.test_results["Swap Information"].update(
    ...
    def get_disk_info(self):
        ...
        self.test_results["Disk Information"]["Total read (Since Boot)"] = self.util_obj.get_size(disk_io.read_bytes)
        self.test_results["Disk Information"]["Total write (Since Boot)"] = self.util_obj.get_size(disk_io.write_bytes)
    ...
    def get_network_info(self):
        ...
        self.test_results["Network Information"]["Total Bytes Sent (Since Boot)"] = self.util_obj.get_size(net_io.bytes_sent)
        self.test_results["Network Information"]["Total Bytes Received (Since Boot)"] = self.util_obj.get_size(net_io.bytes_recv)
